		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EDI Attribute Maintenance",
									"targetURL": "#comatpdediattrpdediattr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comatpdediattrpdediattr-display": {
								"semanticObject": "comatpdediattrpdediattr",
								"action": "display",
								"description": "EDI attribute maintenance for Partner Directory",
								"title": "EDI Attribute Maintenance",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.at.pd.edi.attr.pdediattr",
									"url": sap.ui.require.toUrl("com/at/pd/edi/attr/pdediattr")
								}
							}
						}
					}
